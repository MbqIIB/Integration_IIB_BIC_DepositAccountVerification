...
public class PWRetreiverBIC extends MbJavaComputeNode {
...
// DepositAccountVerification
			m = e.getMessageFlowByName("com.tcfbank.www.DepositAccountVerification");
			attribute = (String) m.getUserDefinedProperty("TestingTool");
			if (attribute.equalsIgnoreCase("empty")){
						PWRetriever("TestingTool");
			}
			attribute = (String) m.getUserDefinedProperty("BIC_user");
			if (attribute.equalsIgnoreCase("empty")){
